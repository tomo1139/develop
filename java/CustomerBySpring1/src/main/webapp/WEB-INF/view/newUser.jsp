		...
		<div id="loginform">
			<form:form modelAttribute="formNewUser" id="loginFormId">
					...
					<div id="newUserIdText">
						ID <form:input path="name" placeholder="name" cssClass="nameformclass" onInput="checkRegist();" pattern="^[0-9a-zA-Z]+$" title="※半角英数" required="true"/>
					</div>

					<div id="nameErrorJS"></div>

					<div id="newUserPassText">
						PASS <form:password path="pass" placeholder="password" cssClass="passformclass" onInput="checkRegist();" pattern="^[0-9a-zA-Z]+$" title="※半角英数" required="true"/>
					</div>

					<div id="passErrorNewJS"></div>

					<div id="newUserConfirmPassText">
						Confirm PASS <form:password path="pass2" placeholder="confirm password" cssClass="passformclass2" onInput="checkRegist();" pattern="^[0-9a-zA-Z]+$" title="※半角英数" required="true"/>
					</div>
