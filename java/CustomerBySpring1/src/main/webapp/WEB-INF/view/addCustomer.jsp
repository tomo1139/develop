...
<html>
	...
	<body>
		...
		<div id="addCustomerTitle">
			<i class="fa fa-users fa-icon"></i>顧客データ追加
		</div>

		<div id="addCustomerFormMain">
			<spring:url value="AddCustomer" var="action" />
			...
			<div id="textMargin1">
				...
				<div id="idForm">
					<form:input required="true" path="id"/>
				</div>
			</div>
		  	-->
			...
			<div id="searchButton">
				<input type="submit" class="SearchButton" value="追加">
			</div>
