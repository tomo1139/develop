	...
	<body onload="nowloadingOff(); createBomb('canvasId');">
		...
		<div id="loginform">
			<form:form modelAttribute="formLogin" id="loginFormId">
				...
				<div id="loginIdText">
				ID <form:input path="name" id="name" name="name" class="nameformclass" onInput="checkLogin();" placeholder="name" type="text" pattern="^[a-zA-Z]+$" title="※半角英字" maxlength="32" required="true" />
				</div>

				<div id="nameErrorLoginJS"></div>

				<div id="loginPassText">
				PASS <form:password path="pass" placeholder="password" cssClass="passformclass" pattern="^[0-9a-zA-Z]+$" title="※半角英数" onInput="checkLoginPass();" name="loginPass" maxlength="8" required="true"/>
				</div>
