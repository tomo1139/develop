...
<html>
	...
	<body>
		...
		<div id="addCustomerFormMain">
			...
			<div id="idForm">
				<form:input required="true" path="address" maxlength="32" placeholder="東京都渋谷区代々木1-21-10"/><br>
			</div>
			</div>
			...
			<div id="idForm">
				<form:input pattern="[0-9]{4}/[0-9]{2}/[0-9]{2}" title="次の形式で入力して下さい。4桁の数字/2桁の数字/2桁の数字" maxlength="10" type="datetime" id="contract_date" required="true" path="contract_date" readonly="true" value="${contract_date_print}"/><br>
				<script>
					$(function(){
			...
			<div id="searchButton">
				<input id="editCustomerEditButtonId" type="submit" class="SearchButton" value="更新">
			</div>
